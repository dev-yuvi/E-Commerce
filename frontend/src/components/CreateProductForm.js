...
const categories=["jeans","bags","jackets","shoes","suits","tshirts","glasses"]
  ...
  const handleSubmit = async (e)=>{
    ...
    await createProduct(newProduct);
     ...
     setNewProduct({
      ...
      console.log(error,"error occured in create product");
    }
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="name" className="block text-gray-300 text-sm font-medium">
          ...
          text-white focus:outline-none focus:ring-emerald-500 focus:ring-2 focus:border-emerald-500 "
          required
          />
      </div>
      {/* Product Description */} 
      ...
      {/* Product Price */}
      <div>
        <label htmlFor="price" className="block text-gray-300 text-sm font-medium">
         Price
        </label>
          <input 
          type="number"
